...
RF_Model = randomForest(x = dev_dataset[-12],
                        ...
                        nodesize = 15)
RF_Model
plot(RF_Model, main = "optimized ntrees vs OOB error")  # 20.22% OOB
# optimizing mtry
set.seed(123)
...
tuned_RF_model #tune_RF - mtry 3  20.43% OOB
require(caret)
set.seed(123)
...
write.csv(test_dataframe,'RF_Solution_2.csv',row.names = F)
